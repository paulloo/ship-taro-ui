...
declare type OmitSelputProps = Omit<
  InputProps,
  | 'className'
  | 'type'
  | 'onBlur'
...
export interface AtSelputProps extends AtComponent, OmitSelputProps {
  ...
  maxLength: number
  isOpened: boolean
  onTipsClick?: InputFunction<string | number, ConfirmEventDetail>
  onSelect?: InputFunction<string | number, ConfirmEventDetail>
  onChooseCerts?: InputFunction<string | number, ConfirmEventDetail>
  closeActionSheet?: InputFunction<string | number, ConfirmEventDetail>
...
declare const AtSelput: ComponentClass<AtSelputProps>

export default AtSelput
