...
import AtCountdownItem from './AtCountdownItem'
    ...
    public render(): JSX.Element {
        ...
        return (
            <View
              ...
              style={customStyle}
            >
                {isShowDay && <AtCountdownItem num={_day} separator={format && format!.day} />}
                {isShowHour && (
                    <AtCountdownItem num={_hours} separator={format && format!.hours} />
                )}
                <AtCountdownItem num={_minutes} separator={format && format!.minutes} />
                <AtCountdownItem num={_seconds} separator={format && format!.seconds} />
            </View>
        );
    }
}
