...
export default class Index extends Component<{}, PanelBasicState> {
    ...
    private gotoComponent = (e: CommonEvent): void => {
        ...
        let url = `/pages/${parent.toLowerCase()}/${id.toLowerCase()}/index`
        if(id === 'Calendar') {
            url += `?start=2020-03-30&end=&from=烟台&to=大连&round=1&cycle=0&saleDays=32&reserveDays=12&picktype=start`
        }
        Taro.navigateTo({
            url
        })
